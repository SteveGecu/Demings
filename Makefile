...
run-qa:
	docker run --env ENV='qa' --env ONLY_TEST_THESE_DSNS='001f7b3b4d02,001f7b1e128d' --env STORE_ID='6' --env CUSTOMER_ID='4' --env OBSERVR_RAILS='0739633A-0C07-4188-90B5-356D0EEAB88D' test-suite-automation:latest
